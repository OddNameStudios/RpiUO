        ...
        */
        public override void OnDamagedBySpell(Mobile attacker)
        {
            ...
            if (0.8 > Utility.RandomDouble() && !attacker.InRange(this, 1))
            {
                ...
                * Damage: 50-65
                */
                Effects.SendPacket(attacker, attacker.Map, new HuedEffect(EffectType.Moving, Serial.Zero_sr, Serial.Zero_sr, 0x27A3, this.Location, attacker.Location, 10, 0, false, false, 0, 0));
