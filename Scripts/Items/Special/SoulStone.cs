    ...
    public class SoulStone : Item, ISecurable
    {
        ...
        private class ConfirmSkillGump : Gump
        {
            ...
            public override void OnResponse(NetState sender, RelayInfo info)
            {
                ...
                Effects.SendMovingParticles(new Entity(Server.Serial.Zero_sr, new Point3D(from.X - 6, from.Y - 6, from.Z + 15), from.Map), from, 0x36D4, 7, 0, false, true, 0x497, 0, 9502, 1, 0, (EffectLayer)255, 0x100);
