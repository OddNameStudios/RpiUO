...
namespace Server.Items
{
    ...
    public class CrushingBlow : WeaponAbility
    {
        ...
        public override void OnHit(Mobile attacker, Mobile defender, int damage)
        {
            ...
            Effects.SendMovingParticles(new Entity(Serial.Zero_sr, new Point3D(defender.X, defender.Y, defender.Z + 50), defender.Map), new Entity(Serial.Zero_sr, new Point3D(defender.X, defender.Y, defender.Z + 20), defender.Map), 0xFB4, 1, 0, false, false, 0, 3, 9501, 1, 0, EffectLayer.Head, 0x100);
        }
    }
}