...
namespace Server.Items
{
    ...
    public class ConcussionBlow : WeaponAbility
    {
        ...
        public override bool OnBeforeDamage(Mobile attacker, Mobile defender)
        {
            ...
            Effects.SendMovingParticles(new Entity(Serial.Zero_sr, new Point3D(defender.X, defender.Y, defender.Z + 10), defender.Map), new Entity(Serial.Zero_sr, new Point3D(defender.X, defender.Y, defender.Z + 20), defender.Map), 0x36FE, 1, 0, false, false, 1133, 3, 9501, 1, 0, EffectLayer.Waist, 0x100);
