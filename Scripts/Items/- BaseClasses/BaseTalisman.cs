                ...
                else
                {
                    switch (this.m_Talisman.Removal)
                    {
                        case TalismanRemoval.Curse:
                            ...
                            IEntity mfrom = new Entity(Serial.Zero_sr, new Point3D(target.X, target.Y, target.Z - 10), from.Map);
                            IEntity mto = new Entity(Serial.Zero_sr, new Point3D(target.X, target.Y, target.Z + 50), from.Map);
